...
function M.get(config)
	...
	theme = {
		...
		-- DiagnosticUnderlineError = { sp = groups.error, style = "underline" },
		-- DiagnosticUnderlineHint = { sp = groups.hint, style = "underline" },
		-- DiagnosticUnderlineInfo = { sp = groups.info, style = "underline" },
		-- DiagnosticUnderlineWarn = { sp = groups.warn, style = "underline" },
		...
		NeoTreeModified = { fg = p.primary },

		-- Bufferline
		BufferLineModified = { fg = p.primary },
		BufferLineModifiedSelected = { fg = p.primary },
		BufferLineModifiedVisible = { fg = p.primary },
		BufferLineIndicatorSelected = { fg = p.color100 },
		...
		BlinkCmpMenuBorder = { fg = p.color100 },
		...
		BlinkCmpDocBorder = { fg = p.color100 },
		BlinkCmpSignatureHelpBorder = { fg = p.color100 },
